    ...
    public class CatalogService
    {
        ...
        { 
            ...
            try
            {
                ...
                return await _httpClient.GetFromJsonAsync<List<ProductDto>>(url, cts.Token) ?? new();
            }
            catch (Exception ex)
            {
                Console.WriteLine($"[CatalogService] GetProducts hatası: {ex.Message}");
        ...
        public async Task<ProductDto?> GetProductById(string id)
        {
            ...
            try
            {
                return await _httpClient.GetFromJsonAsync<ProductDto>($"/catalog/api/products/{id}", cts.Token);
            }
            catch (Exception ex)
            {
                Console.WriteLine($"[CatalogService] GetProductById ({id}) hatası: {ex.Message}");
                return null;
            }
        }
